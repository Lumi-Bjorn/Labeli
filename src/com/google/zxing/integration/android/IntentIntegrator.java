...
public class IntentIntegrator {
	...
	public static final String DEFAULT_TITLE = "Installer Barcode Scanner?";
	public static final String DEFAULT_MESSAGE = "L'application a besoin de Barcode Scanner pour fonctionner. Voulez-vous l'installer ?";
	public static final String DEFAULT_YES = "Oui";
	public static final String DEFAULT_NO = "Annuler";
